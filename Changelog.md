 ...
 * Add ``public`` to every function that doesn't specify its visibility already.
 ...
 * Syntax Checker: Strictly enforce visibility specifier. This was already the case in the experimental 0.5.0 mode.
